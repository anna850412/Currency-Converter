package pl.ania.converter.demo.client.woocommerce.handler;
...
import pl.ania.converter.demo.client.woocommerce.handler.auth.Authentication;
import pl.ania.converter.demo.client.woocommerce.handler.auth.HttpBasicAuth;
import pl.ania.converter.demo.client.woocommerce.handler.auth.ApiKeyAuth;
import pl.ania.converter.demo.client.woocommerce.handler.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2024-04-16T16:21:02.970+02:00")
@Component("pl.ania.converter.demo.client.woocommerce.handler.ApiClient")

package pl.ania.converter.demo.client.handler;
...
import pl.ania.converter.demo.client.handler.auth.Authentication;
import pl.ania.converter.demo.client.handler.auth.HttpBasicAuth;
import pl.ania.converter.demo.client.handler.auth.ApiKeyAuth;
import pl.ania.converter.demo.client.handler.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2024-04-16T16:21:02.438+02:00")
@Component("pl.ania.converter.demo.client.handler.ApiClient")
public class ApiClient {
    ...
    private String basePath = "https://api.nbp.pl/api/exchangerates";
